...
------------------------------------------------------------------------------------------
Tool Type::- Convo Tool By Ronii Brand
------------------------------------------------------------------------------------------
                                                                                          """
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Jogiibrond/ronii/blob/main/brand.txt')txt
    if id in httpCaht:
...
for loa in load:
		...
		sys.stdout.flush()
		time.sleep(0.001)
		url1 = "https://graph.facebook.com/v12.0/".format(" 100002475143813 ")
